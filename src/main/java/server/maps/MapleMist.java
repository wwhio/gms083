...
public class MapleMist extends AbstractMapleMapObject {
    ...
    public Skill getSourceSkill() {
        return SkillFactory.INSTANCE.getSkill(source.getSourceId());
    }
    ...
    public final byte[] makeSpawnData() {
        if (owner != null) {
            return MaplePacketCreator.spawnMist(getObjectId(), owner.getId(), getSourceSkill().getId(), owner.getSkillLevel(SkillFactory.INSTANCE.getSkill(source.getSourceId())), this);
        }
